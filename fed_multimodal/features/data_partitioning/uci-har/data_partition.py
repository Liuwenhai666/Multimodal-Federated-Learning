...
def data_partition(args: dict):
    ...
    for data_type in ['train', 'test']:
        ...
        # read labels 原始数据中labels∈[1,6], labels变量∈[0,5]
        ...
        # data for each client client_id=(1,2,3...30)
        for client_id in client_id_list:
            # return data idx belonging to the client, client_data_idx
...
if __name__ == "__main__":
    ...
    parser.add_argument(     # 用于生成No-IID(非独立同分布)数据
        "--alpha",
        type=float,
        default=1.0,
